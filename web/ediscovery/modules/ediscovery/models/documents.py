...
class EdiscoveryDocument(Base):
    ...
    # --- File identity ---
    file_path = Column(String(2000), nullable=False)  # relative to collection storage_path
    original_path = Column(String(2000))  # within originals/unpacked/
    working_path = Column(String(2000))  # within working/
    ...
    email_date = Column(DateTime(fsp=3))
    ...
    reviewed_at = Column(DateTime(fsp=3))
    ...
    # --- Timestamps ---
    ingested_at = Column(DateTime(fsp=3), nullable=False, default=func.now())
